...
export const REAL_CLIPS = new Set<string>([
  ...
  'dunk_self_lob', 'dunk_bounce_throw', 'dunk_kick_up', 'dunk_cartwheel', 'dunk_double_up', 'dunk_scorpion', 'dunk_lost_found', 'dunk_hide_seek', 'dunk_360_spin',   // DUNK-CONTROL-JUICE (2026-09-08): the named dunks
