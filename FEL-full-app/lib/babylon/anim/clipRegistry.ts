...
export const REAL_CLIPS = new Set<string>([
  ...
  'dunk_self_lob', 'dunk_bounce_throw', 'dunk_kick_up', 'dunk_back_handspring', 'dunk_backflip', 'prop_stack_base', 'prop_stack_rider', 'dunk_double_up', 'dunk_scorpion', 'dunk_lost_found', 'dunk_hide_seek', 'dunk_360_spin', 'dunk_between_legs', 'dunk_cradle', 'dunk_double_clutch', 'dunk_behind_back', 'dunk_fake_back', 'dunk_double_eastbay',   // DUNK-CONTROL-JUICE (2026-09-08): the named dunks
