...
export const VENUES: Venue[] = [
  ...
  { key: 'surfbreak', name: 'Surf Break', image: '/venues/surfbreak.jpg', modes: ['The Break'], playable: true, href: '/play/surf' },
  { key: 'links', name: 'Coastal Links', image: '/venues/links.jpg', modes: ['The Loop'], playable: true, href: '/play/golf' },
  { key: 'soccerstadium', name: 'Coastal FC Stadium', image: '/venues/soccerstadium.jpg', modes: ['Twelve Yards'], playable: true, href: '/play/soccer' },
  { key: 'baseballpark', name: 'Catalina Ballpark', image: '/venues/baseballpark.jpg', modes: ['Moonshot Derby'], playable: true, href: '/play/baseball' },
  { key: 'gridiron', name: 'The Gridiron', image: '', modes: ['Breakaway'], playable: true, href: '/play/football' },
  { key: 'lumaveniceshop', name: 'Luma Venice Shop', image: '/venues/lumaveniceshop.jpg', modes: ['Market Browse'], playable: true, href: '/shop' },
  { key: 'courtcarnival', name: 'Court Carnival', image: '/venues/courtcarnival.jpg', modes: ['Slam Rush', 'Strike Storm', 'Trick Gauntlet', 'Hot Shot', 'Coin Storm', 'Counter Strike', '+ mini-game night'], playable: true, href: '/play/carnival' },
...
export const SHOP_CARDS: ShopCard[] = [
  { key: 'drill-jab-flow', name: 'Jab Flow Drill', type: 'DRILL', price: 80, description: 'Speed-chain jab timing drill. Sharpens combo windows in The Hundred.', accent: '#00E5FF' },
  { key: 'drill-vert-charge', name: 'Vert Charge Drill', type: 'DRILL', price: 80, description: 'Perfect-charge repetition drill for max hang time in Flight Night.', accent: '#00FF9D' },
  { key: 'drill-baseline-grind', name: 'Baseline Grind Drill', type: 'DRILL', price: 80, description: 'Rally endurance drill. Improves return positioning in Match Point.', accent: '#FFD700' },
    ...
    modules: [
      {
        ...
        lessons: [
          { key: 'l1', title: 'Charge Mechanics', concept: 'Jump power scales with charge time. A full charge bar maximizes launch velocity — but overcharging past the sweet spot costs control. Watch the bar: release inside the highlighted band.', drill: 'Play Flight Night and land 3 jumps with 80%+ charge.' },
    ...
    modules: [
      {
        ...
        lessons: [
          { key: 'l1', title: 'The Jab (\u25A1)', concept: 'Fastest strike, 1 point. The jab starts every chain — its short recovery keeps the 0.5s combo window alive. Speed beats power early in a chain.', drill: 'Land a 5-hit chain in The Hundred.' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { key: 'l3', title: 'Wave Scaling', concept: 'Waves 1-3: single opponents, aggression 0.6-0.8. By wave 13+: 3 opponents, aggression 1.4, speed \u00D71.15. Survive by rotating — never let them flank.', drill: 'Reach wave 5 in The Hundred.' },
        ],
      },
    ],
  },
...
export const MODE_INFO: Record<string, { name: string; venue: string; href: string }> = {
  ...
  // The Neuro-Mechanic Mirror is a real session experience (pose pipeline,
  // on-device) — it belongs on the Lab menu, not just at a bare URL.
  mirror: { name: 'Neuro-Mechanic Mirror', venue: 'Real World', href: '/play/mirror' },
