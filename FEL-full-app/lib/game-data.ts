...
export const VENUES: Venue[] = [
  ...
  { key: 'mountainslope', name: 'Mountain Slope', image: '/venues/mountainslope.jpg', modes: ['Slalom Descent'], playable: true, href: '/play/snowboard' },
  ...
  { key: 'duelarena', name: 'Weapon Duel Arena', image: '', modes: ['Weapon Duel'], playable: true, href: '/play/duel' },
