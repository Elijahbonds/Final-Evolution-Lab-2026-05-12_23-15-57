...
const ATHLETES: Athlete[] = [
  { key: 'atlas', scale: 1.07, skin: [0.45, 0.30, 0.20], jersey: [0.10, 0.55, 0.60], shorts: [0.06, 0.20, 0.24], shoes: [0.90, 0.90, 0.88], hair: [0.05, 0.04, 0.03], note: 'tall, teal kit' },
  { key: 'blitz', scale: 0.94, skin: [0.85, 0.60, 0.42], jersey: [0.85, 0.20, 0.16], shorts: [0.10, 0.10, 0.12], shoes: [0.75, 0.16, 0.14], hair: [0.35, 0.20, 0.08], note: 'compact, red kit' },
  { key: 'nova',  scale: 1.00, skin: [0.62, 0.42, 0.28], jersey: [0.45, 0.30, 0.80], shorts: [0.16, 0.10, 0.30], shoes: [0.92, 0.85, 0.60], hair: [0.02, 0.02, 0.03], note: 'violet kit' },
  { key: 'titan', scale: 1.12, skin: [0.72, 0.50, 0.34], jersey: [0.90, 0.60, 0.15], shorts: [0.30, 0.18, 0.06], shoes: [0.20, 0.20, 0.22], hair: [0.16, 0.10, 0.06], note: 'big, amber kit' },
];
