...
OUT="$G/run-$(date +%Y%m%d-%H%M%S).txt"
{
  ...
  for m in dunk threepoint threevthree onevone dunkduel karate_vs karate mixedcombat skateboard surf snowboard_slalom bigair freerun volleyball tennis golf derby penalty football carnival dance; do
