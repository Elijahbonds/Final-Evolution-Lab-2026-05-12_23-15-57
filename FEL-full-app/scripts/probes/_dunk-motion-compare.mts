...
type M = { trick: string; sparcMean: number; pops: unknown[]; whips: number; lockedElbow: number; lockedKnee: number; heldFrac: Record<string, number>; ballFar: number; rimHandAtContact: number | null; clips: string[] };
