...
const LEDGER_TAGS = 'AIR-TRICK|AIR-COMBO|AIR-JUDGE|SKATE-LAND|BOARD-LAND|SNOW-GATE|SNOW-ROCK|SNOW-EDGE|SNOW-YETI|SNOW-END|SURF-WIPE|SURF-EDGE|SURF-PUMP|SURF-END|SKATE-SOLID|SKATE-END|NET-SWING|NET-FOE|NET-FLOW|NET-JUICE|GOLF-STRIKE|GOLF-FLOW|GOLF-PARK|GOLF-JUICE|PARK|BREAK|PEN-JUICE|DERBY-JUICE|NET-END|GOLF-END|DERBY-END|PEN-END';
