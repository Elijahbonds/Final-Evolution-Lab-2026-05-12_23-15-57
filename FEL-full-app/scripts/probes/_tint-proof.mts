...
//   BASE=http://localhost:3006 ROUTE=dunk npx tsx scripts/probes/_tint-proof.mts   (a lane port; default stays 3000)
...
await p.goto(`${BASE}/play/${route}`, { waitUntil: 'domcontentloaded' }); await p.waitForSelector('canvas', { timeout: 60000 }); await p.waitForTimeout(9000);
