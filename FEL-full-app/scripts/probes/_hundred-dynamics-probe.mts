...
p.on('console', (m) => { const t = m.text(); if (/MISSING CLIP/.test(t) || m.type() === 'error' && !/401|FEL-FRAME/.test(t)) errs.push(t.slice(0, 160)); if (/\[KE-|\[KVS-|\[MC-|\[SD-|\[DL-|\[MATRIX\]|\[SKATE-|\[ARENA\]|\[NEXUS\]/.test(t)) logs.push(t.slice(0, 160)); });
