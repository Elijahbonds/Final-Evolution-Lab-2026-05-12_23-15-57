...
const SUITES: { script: string; guards: string }[] = [
  ...
  { script: 'karate-neo-tests.ts', guards: 'karate endless — the fighter is not one-tap DOWN, slow-mo latches once, enemies telegraph, drops and perks change the run' },
