 ...
 * 666 commits past it. In the meantime CI ran `tsc`, `vitest run` and `next build`
 * and NOTHING ELSE — so all 186 headless suites, every mode gate and every
 * regression net in scripts/, ran only when a human remembered to. That is the
