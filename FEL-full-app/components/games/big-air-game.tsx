...
export default function BigAirGame({ grade, prq, onEnd, gamepad }: GameProps) {
  ...
  useEffect(() => {
    ...
    const loop = (now: number) => {
      ...
      last = now;
      // msgTimer gates nextJump() below — track real elapsed time so rAF
      // throttling (backgrounded tab, low-power mode) can't leave the round
      // stuck on the crash/landing message forever.
