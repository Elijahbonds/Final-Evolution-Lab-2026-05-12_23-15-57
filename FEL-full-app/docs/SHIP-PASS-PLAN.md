...
| **5 Combat, board, air** 🔶 sidestep, spin direction, horde pass landed (H1–H8 ✅) |  karate, karate_vs (the Storm mode), mixedcombat (Soul Calibur style), skateboard, surf, snowboard_slalom, bigair (SSX), gymnastics. | §7 sign-off per mode. |
