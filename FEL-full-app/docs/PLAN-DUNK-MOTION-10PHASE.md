...
| 10b | The named dunks (owner, 2026-09-24: Jus Fly's cartwheel, the 720, "my kick up", Kilganon's scorpion) | each watched on video first: the scorpion from the hip, behind the head, head ducked under it, jammed in the shape (its own flush); the owner's kick-up a low flick off the foot (the ball carried onto the foot); Jus Fly's real cartwheel (X + down, the ball bounced, THE CARTWHEEL EASTBAY); the 720 = the 360 thrown again (the turn extended, not restarted); the eastbay, behind the back and between the legs pass TO the dunking hand | the sheets against the videos; every dunk ON TIME |
| 11 ✓ | Right-handed everywhere; the rival as a player; rim, hang, land (done 2026-09-24: bindBody + an AI pad through the player's pipeline; dunkHand for 1v1 / 3v3; Duel on arcHeight; the live gravity drop and landing before the replay) | Dunk Duel, the rival, the 1v1 / 3v3 game dunks mirrored too (owner: "every dunk, every body"); the rival's turn run through the same attempt pipeline, like another person playing (owner: "it needs to look like one of the users attempts"); the hang and the land | every dunk mode on the sheets |
| 12 ✓ | Effects and celebrations (done 2026-09-24: the pose-replay triple cut, speed ramp + sound gap, the stand shudder, phone flashes, pyro, the announcer, the shareable poster; Ruffin's Spider-Man splits, Carter's "it's over", the roar, too small — thrown on the d-pad) | the triple camera cut on every make (skippable, ~2 s); the rim, the net and the glass react; the speed ramp, the impact frame, the sound gap; the crowd and the announcer; the poster freeze-frame; post-dunk celebration emotes from real dunkers (Brandon Ruffin and others) | owner decisions, 2026-09-23 |
| 13 ✓ | The score loop (done 2026-09-24: 21 dunks in both runs, re-scored with today's metrics: pops per dunk 13.67 → 4.48, whips 11.57 → 1.76, severe pops 17 → 12, locked-elbow frames 63.8 → 33.1, ball from the rim's centre 0.27 → 0.16 m, hand on top 0 → 10 / 21, ON TIME 21 / 21; SPARC −3.44 → −3.60, more real movement in the flight window; deployed to final-evolution-lab) | the full re-measure against the baseline, the summary, ONE deploy | every number against the baseline: `~/Claude/outbox/finish-release/dunkmotion/DUNK-MOTION-PASS-SUMMARY.md` |
