...
> **Status (2026-09-03):** the criteria table below is the PRE-FIX snapshot from the concept lock. Every ❌ it lists was worked in the convergence pass; `snowboard-signoff.md` records which were fixed, which were accepted and why. Read the two together.
