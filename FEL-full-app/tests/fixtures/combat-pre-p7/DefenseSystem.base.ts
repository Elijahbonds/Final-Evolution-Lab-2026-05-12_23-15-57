...
// code and never edit it. Everything below this header is `git show b440b737:FEL-full-app/lib/babylon/core/DefenseSystem.ts`: the
...
// (its FightCore import points at the frozen FightCore copy)
...
import type { AttackDef, FighterState } from './FightCore.base';
import { PARRY_WINDOW_MS } from './FightCore.base';
